...
const termAliases = {
  ...
  'multi-part payments': ['mpp', 'multi-part payments', 'multipart', 'payment splitting'],
...
const pathKeywords = {
  ...
  '/docs/bitcoin/consensus': ['consensus', 'proof of work', 'pow', 'nakamoto consensus'],
  '/docs/bitcoin/transaction-structure': ['transaction structure', 'txid', 'vout', 'vin', 'outpoint', 'scriptPubKey', 'scriptSig'],
  '/docs/bitcoin/transaction-fees': ['transaction fees', 'fee rate', 'sat/vB', 'vbytes', 'rbf', 'cpfp', 'replace-by-fee'],
  '/docs/bitcoin/transaction-malleability': ['malleability', 'transaction malleability', 'malleable'],
  '/docs/bitcoin/coinbase-transaction': ['coinbase', 'coinbase transaction', 'block reward'],
  '/docs/bitcoin/data-encoding': ['data encoding', 'base58', 'bech32', 'serialization', 'compact size'],
  '/docs/bitcoin/p2p-protocol': ['p2p', 'peer-to-peer', 'network protocol'],
  '/docs/bitcoin/witness': ['witness', 'witness data', 'segwit witness'],
  ...
  '/docs/lightning/routing/mpp': ['mpp', 'multi-part payments', 'multipart', 'payment splitting', 'split payment'],
  '/docs/lightning/routing-fees': ['routing fee', 'base fee', 'ppm', 'fee formula', 'millisatoshis', 'msat', 'htlc fee'],
  '/docs/lightning/watchtowers': ['watchtower', 'watchtowers'],
  '/docs/lightning/anchor-outputs': ['anchor output', 'anchor outputs', 'anchor', 'cpfp'],
  ...
  '/docs/bitcoin-development/keys': ['key management', 'private key', 'wif', 'wallet import format'],
  '/docs/bitcoin-development/fee-estimation': ['fee estimation', 'estimatesmartfee', 'fee rate'],
  '/docs/bitcoin-development/fee-bumping': ['fee bumping', 'rbf', 'cpfp', 'replace-by-fee', 'child pays for parent', 'bip125'],
  ...
  '/docs/wallets/privacy': ['payjoin', 'p2ep'],
  '/docs/bitcoin-development/descriptors': ['descriptor', 'output descriptor', 'bip380', 'bip386'],
  '/docs/advanced/dlcs': ['dlc', 'dlcs', 'discreet log contract'],
  '/docs/advanced/trampoline-routing': ['trampoline', 'trampoline routing', 'lightweight client'],
  '/docs/advanced/zero-conf-channels': ['zero-conf', 'zero conf', 'turbo channel', 'turbo channels'],
  '/docs/advanced/statechains': ['statechain', 'statechains'],
  '/docs/advanced/sidechains': ['sidechain', 'sidechains', 'layer 2', 'l2'],
  '/docs/advanced/atomic-swaps': ['atomic swap', 'atomic swaps', 'htlc', 'trustless exchange'],
