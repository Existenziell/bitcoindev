      ...
      <section className="mb-12">
        <div className="">
          ...
          <p className="text-gray-800 dark:text-gray-200 leading-7 mb-4">
            ...
            no paywalls, <Link href="/privacy" className="link">no tracking</Link>. Just pure Bitcoin knowledge for anyone
            who wants to learn.
          </p>
          <p className="text-gray-800 dark:text-gray-200 leading-7">
            I would love to <Link href="/feedback" className="link">get feedback</Link> from fellow Bitcoiners. I&apos;m still learning every day :)
          </p>
        </div>
      </section>
