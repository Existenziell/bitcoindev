...
/** Chevrons pointing inward with horizontal bar (collapse / contract). Use for "collapse nav" state. */
...
/** Chevrons pointing outward with horizontal bar (expand). Use for "expand nav" state. */
