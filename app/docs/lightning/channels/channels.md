...
- **Splice-in**: You add an extra [input](/docs/glossary#input) (and possibly [output](/docs/glossary#output)) to a new **funding [transaction](/docs/bitcoin/transaction-lifecycle)** that spends the existing 2-of-2 [multisig](/docs/glossary#multisig) [UTXO](/docs/glossary#utxo) and creates a **new** 2-of-2 with a larger (or smaller) amount. Both parties sign; the channel capacity is updated on [confirmation](/docs/glossary#confirmation).
