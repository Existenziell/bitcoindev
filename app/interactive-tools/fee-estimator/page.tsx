    ...
    <DocsLayoutWrapper defaultSidebarCollapsed={true}>
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <p className="text-secondary text-sm">
          See <Link href="/docs/bitcoin-development/fee-estimation" className="text-btc hover:underline">Fee Estimation</Link> and{' '}
          <Link href="/docs/bitcoin/transaction-fees" className="text-btc hover:underline">Transaction Fees</Link>. Rates are
